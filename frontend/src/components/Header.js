    ...
    return(
        <div className="w-full fixed md:static md:bg-transparent overflow:hidden">
                ...
                <div className="w-10/12 mx-auto flex justify-between">
                    <div className="text-gray-100 flex justify-between items-center">
                        <div className="flex justify-between lato mr-10">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-phone mr-2" width="24" height="24" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ffffff" fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                            <path d="M5 4h4l2 5l-2.5 1.5a11 11 0 0 0 5 5l1.5 -2.5l5 2v4a2 2 0 0 1 -2 2a16 16 0 0 1 -15 -15a2 2 0 0 1 2 -2" />
                            </svg>
                            <span>1.826.723.800</span>
                        </div>
                        <div className="flex justify-between lato">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-mail mr-2" width="24" height="24" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ffffff" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                                <rect x="3" y="5" width="18" height="14" rx="2" />
                                <polyline points="3 7 12 13 21 7" />
                            </svg>
                            <span>Contact@MyTinerary.io</span>
                        </div>
                    </div>
                    <div>
            ...
            <div className="bg-black bg-opacity-75 h-24 flex items-center">
                ...
                <div className="w-10/12 mx-auto flex justify-between text-white items-center">
                    <NavLink className="" exact to="/">
                        <div className="flex flex-row items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" class="mb-3 icon icon-tabler icon-tabler-plane-departure" width="50" height="50" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#ffffff" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                                <path d="M15 12h5a2 2 0 0 1 0 4h-15l-3 -6h3l2 2h3l-2 -7h3z" transform="rotate(-15 12 12) translate(0 -1)" />
                            <line x1="3" y1="21" x2="21" y2="21" />
                            </svg>    
                            <span className="text-3xl ml-2 md:text-2xl lato font-normal"><span className="text-blue-300">MY</span>TINERARY</span>
                        </div>
                    ...
                    <div className="flex hidden md:block">
                        <div className="flex justify-between items-center  lato font-normal">
                            ...
                            <span className="mx-2 px-4 py-1 bg-red-500 bg-red-600 duration-500 transition hover:bg-white hover:text-red-700 hover:border hover:border-red-400 rounded cursor-pointer">Sign Up</span>
